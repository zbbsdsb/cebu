...
void test_stream_load() {
    ...
    std::cout << "�?Stream load test passed" << std::endl;
}
...
void test_stream_write() {
    ...
    std::cout << "�?Stream write test passed" << std::endl;
}
...
void test_progress_callback() {
    ...
    std::cout << "�?Progress callback test passed" << std::endl;
}
...
void test_file_metadata() {
    ...
    std::cout << "�?File metadata test passed" << std::endl;
}
...
void test_compressed_file() {
    ...
    std::cout << "�?Compressed file test passed" << std::endl;
}
...
void test_stream_labeled() {
    ...
    std::cout << "�?Stream labeled test passed" << std::endl;
}
...
void test_compression_settings() {
    ...
    std::cout << "�?Compression settings test passed" << std::endl;
}
...
void test_chunk_loading() {
    ...
    std::cout << "�?Chunk loading test passed" << std::endl;
}
...
void test_large_file_metadata() {
    ...
    std::cout << "�?Large file metadata test passed" << std::endl;
}
...
void test_multiple_writes() {
    ...
    std::cout << "�?Multiple writes test passed" << std::endl;
}
