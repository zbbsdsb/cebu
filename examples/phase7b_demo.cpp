...
int main() {
    ...
    try {
        ...
        std::cout << "  âœ?JSON Serialization" << std::endl;
        std::cout << "  âœ?Change Tracking" << std::endl;
        std::cout << "  âœ?Snapshot Management" << std::endl;
        std::cout << "  âœ?Version Control" << std::endl;
        std::cout << "  âœ?Persistence (Save/Load)" << std::endl;
        std::cout << "  âœ?Streaming I/O (header included)" << std::endl;
        std::cout << "  âœ?Compression (header included)" << std::endl;
        std::cout << "\né¢ è¦†æ€§äº§å“?CEBU Phase 7b å·²å°±ç»ªï¼ðŸš€\n" << std::endl;
